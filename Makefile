...
cdir = src/common/
COMM_SRCS = $(cdir)common.c $(cdir)compiler.c $(cdir)cygwin.c $(cdir)dynamic.c $(cdir)env.c $(cdir)home.c $(cdir)os.c $(cdir)partition.c $(cdir)uid.c $(cdir)uname.c $(cdir)which.c $(cdir)windows.c
SRCS = $(cdir)filesystem.cpp $(cdir)c_ifc.cpp $(cdir)/copy.cpp $(cdir)ifc.cpp $(cdir)inquire.cpp $(cdir)mkdir.cpp $(cdir)pure.cpp $(cdir)platform.cpp $(cdir)resolve.cpp $(cdir)symlink.cpp $(cdir)time.cpp $(cdir)touch.cpp
