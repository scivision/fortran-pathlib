...
COMM_SRCS = $(comdir)inquire2.cpp $(comdir)filesystem.cpp $(comdir)c.cpp $(comdir)common.c $(comdir)compiler.cpp $(comdir)cpu.cpp $(comdir)cygwin.c $(comdir)exepath.cpp $(comdir)env.cpp $(comdir).cpp $(comdir)libpath.cpp $(comdir)limits.cpp $(comdir)mkdtemp.c $(comdir)owner.c $(comdir)os.c $(comdir)partition.c $(comdir)realpath.cpp $(comdir)space.cpp $(comdir)sysctl.cpp $(comdir)symlink.cpp $(comdir)touch.cpp $(comdir)uid.cpp $(comdir)uname.cpp $(comdir)which.c $(comdir)windows.cpp $(comdir)winsock.cpp
