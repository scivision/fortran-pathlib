...
cdir = src/common/
COMM_SRCS = $(cdir)common.c $(cdir)compiler.c $(cdir)cygwin.c $(cdir)dynamic.c $(cdir)env.c $(cdir)home.c $(cdir)os.c $(cdir)partition.c $(cdir)uid.c $(cdir)uname.c $(cdir)windows.c
